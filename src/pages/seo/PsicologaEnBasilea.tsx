...
const PsicologaEnBasilea = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer: "Basilea es conocida mundialmente como la capital de la industria farmacéutica. Novartis, Roche, y numerosas empresas biotecnológicas de vanguardia tienen su sede aquí, atrayendo a científicos, investigadores, y profesionales altamente cualificados de todo el mundo. Para muchos hispanohablantes, Basilea representa la oportunidad de trabajar en la vanguardia de la ciencia biomédica, con recursos y posibilidades que serían impensables en otros contextos."
    },
    {
      question: "¿Cómo afecta la región trinacional a la vida de los hispanohablantes?",
      answer: "La situación trinacional ofrece ventajas prácticas significativas: muchas personas que trabajan en Basilea viven en Francia o en Alemania, donde el costo de vida es menor. Sin embargo, esta dispersión geográfica también puede dificultar la formación de comunidad. Los hispanohablantes que trabajan en Basilea pueden vivir en tres países diferentes, lo que complica la organización de encuentros sociales y la formación de vínculos."
    },
    {
  ...
  return (
    ...
    >
      <h2 className="text-2xl font-semibold mt-8 mb-4">
        Temas frecuentes en la comunidad de Basilea
      </h2>
      ...
      <p>
        No estás limitado a los pocos psicólogos hispanohablantes que puedan existir localmente (si es que existen): puedes acceder a atención de calidad en tu idioma sin importar dónde vivas en la región trinacional.
      </p>
