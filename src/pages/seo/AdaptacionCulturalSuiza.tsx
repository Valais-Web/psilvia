...
const AdaptacionCulturalSuiza = () => {
  const faqs = [
    {
      ...
      answer: "El duelo migratorio son las pérdidas que implica migrar: familia, amigos, estatus, idioma, paisaje, y una versión de ti mismo. A diferencia de otros duelos, es invisible socialmente y puede reactivarse en momentos específicos. No hay funeral, no hay fecha en el calendario, nadie te da el pésame ni te envía flores. Pero las pérdidas son muy reales, aunque la sociedad no las reconozca ni las valide."
    },
    {
    ...
    {
      question: "¿En qué consiste el choque cultural más allá de las diferencias superficiales?",
      answer: "Cuando hablamos de adaptación cultural, muchas veces pensamos en las diferencias superficiales: el idioma, la comida, el clima, las costumbres. Pero el choque cultural más profundo tiene que ver con algo más fundamental: un desajuste entre la forma en que has aprendido a entender el mundo, a relacionarte con los demás, a expresar emociones, a organizarte en el tiempo, y cómo funciona el nuevo entorno. En Suiza, las reglas implícitas de interacción social son diferentes: el nivel de formalidad esperado, la distancia física y emocional en las relaciones, la importancia de la puntualidad y la planificación."
    },
    {
      question: "¿Por qué el duelo migratorio es particularmente complejo?",
      answer: "Lo que hace al duelo migratorio particularmente complejo es que es un duelo 'parcial' y 'recurrente'. A diferencia de la muerte de un ser querido, las personas y lugares que dejaste siguen existiendo. Están ahí, al otro lado de una pantalla o un vuelo transoceánico. Esto genera una ambivalencia constante: no los has perdido del todo, pero tampoco los tienes realmente. Además, el duelo migratorio se reactiva periódicamente: cada vez que alguien en tu familia se enferma y tú no puedes estar ahí, cada vez que celebran un cumpleaños, una boda, un bautizo sin ti."
    },
    {
      question: "¿Qué se trabaja en terapia sobre adaptación cultural?",
      answer: "Mi enfoque combina elementos de la terapia cognitivo-conductual con un trabajo más profundo sobre identidad, pertenencia y significado. Incluye: procesar el duelo dando espacio legítimo a las emociones; explorar la identidad integrando las diferentes partes de quién eres; manejar el estrés de adaptación con estrategias concretas; fortalecer recursos y redes de apoyo; y encontrar equilibrio entre adaptarte al nuevo entorno y mantener tus raíces."
    },
    {
      question: "¿Por qué es importante trabajar con alguien que comprende la experiencia migratoria?",
      answer: "Una de las ventajas de trabajar conmigo es que conozco de cerca el contexto cultural suizo y comprendo las particularidades de la experiencia migratoria latinoamericana y española. Sé lo que significa sentirse entre dos mundos, negociar diferentes expectativas culturales, y buscar un lugar donde sentirse realmente en casa. En nuestras sesiones, no tendrás que explicar constantemente de dónde vienes o por qué ves las cosas de cierta manera. No tendrás que justificar por qué extrañas tu país a pesar de que 'objetivamente todo está mejor aquí'."
    }
  ];
  ...
  return (
    ...
    >
      ...
      <p>
        Para alguien que viene de una cultura latina, donde la calidez, la espontaneidad y la expresividad son la norma, la reserva suiza puede sentirse fría, distante, o incluso hostil. No se trata de que una cultura sea mejor que otra; son simplemente diferentes. Pero cuando vives esta diferencia en el día a día, cuando te sientes fuera de lugar en situaciones cotidianas, cuando no entiendes las señales sociales que para otros son obvias, el impacto emocional puede ser significativo.
      </p>

      <p className="mt-4">
        Muchas personas me describen la experiencia como "estar constantemente actuando", como si tuvieran que usar una máscara para encajar, sin poder ser realmente ellos mismos.
      </p>

      <h2 className="text-2xl font-semibold mt-10 mb-4">
        Las pérdidas invisibles de la migración
      </h2>
      ...
      <h2 className="text-2xl font-semibold mt-10 mb-4">
        Acompañamiento que comprende tu experiencia
      </h2>
      
      <p>
        En nuestras sesiones, no tendrás que traducir tu experiencia emocional a un idioma y un marco cultural que no es el tuyo. Este conocimiento compartido me permite ofrecerte un acompañamiento más preciso, más empático, y más relevante para tu realidad.
      </p>
