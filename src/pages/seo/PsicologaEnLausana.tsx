...
const PsicologaEnLausana = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "El camino del doctorado y el posdoctorado está lleno de presiones que rara vez se discuten abiertamente. La incertidumbre laboral es constante: ¿Conseguiré una posición después? ¿Debo seguir en la academia o irme a la industria? Las relaciones con los supervisores pueden ser complicadas, ya que el supervisor tiene un poder enorme sobre tu carrera. El equilibrio vida-trabajo es otro desafío, con límites difusos entre el tiempo de trabajo y el tiempo personal.",
    },
    {
  ...
  return (
    <SEOPageLayout
      ...
      description="Psicoterapia online para personas que viven en Lausana. Atención psicológica privada en español sin esperas. 80 CHF la sesión."
    ...
    >
      <h2 className="text-2xl font-semibold mt-8 mb-4">Desafíos comunes en la comunidad de Lausana</h2>

      <p>
        El ambiente académico suizo es extremadamente exigente. No es sorprendente que los problemas de salud mental
        sean comunes en la población doctoral, incluyendo ansiedad, depresión, y burnout.
      </p>
      ...
      <p>
        La belleza natural de la región –el lago Lemán, los viñedos de Lavaux, las montañas– puede hacer que sea difícil
        admitir que no todo está bien. "¿Cómo puedo estar deprimido viviendo aquí?" es una pregunta que escucho con
        frecuencia. Pero la calidad de vida externa no garantiza el bienestar interno, y las presiones de la vida
        académica o profesional internacional son muy reales aunque el paisaje sea hermoso.
      </p>

      <h2 className="text-2xl font-semibold mt-10 mb-4">Estudiantes y jóvenes profesionales</h2>

      <p>
        La cultura del "publish or perish" (publica o muere) genera una presión constante que puede llevar al
        agotamiento. Algunos supervisores son exigentes; otros simplemente tienen estilos de trabajo incompatibles con
        los tuyos. Navegar estas dinámicas mientras intentas producir trabajo de calidad es agotador.
      </p>

      <p className="mt-4">
        Si vives en Lausana o la región del lago Lemán y buscas apoyo psicológico en español, estoy aquí para ayudarte.
        Ya sea que estés luchando con las presiones del doctorado, la soledad de la vida expatriada, los desafíos de la
        crianza bicultural, o cualquier otro tema emocional, podemos trabajar juntas para encontrar alivio y dirección.
      </p>
    </SEOPageLayout>
  );
};
