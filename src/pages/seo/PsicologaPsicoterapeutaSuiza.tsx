...
const PsicologaPsicoterapeutaSuiza = () => {
  const faqs = [
    {
      ...
      answer:
        "Soy Licenciada en Psicología por una universidad reconocida en México, con formación de posgrado en Psicoterapia Cognitivo-Conductual en España. Esta formación me habilita para ejercer la psicoterapia de manera privada.",
    },
    {
      question: "¿Estás acreditada en el sistema de salud suizo?",
      answer:
        "No, mi formación fue obtenida en México y España, no en Suiza. Esto significa que ofrezco psicoterapia privada que no está cubierta por el seguro de salud suizo. Soy transparente sobre este encuadre.",
    },
    {
      question: "¿Cuál es la diferencia entre psicoterapia privada y cubierta por seguro?",
      answer:
        "La psicoterapia cubierta por seguro requiere profesionales acreditados en Suiza y suele tener listas de espera. La privada ofrece más flexibilidad, atención inmediata, tarifas más accesibles, y en mi caso, atención en español.",
    },
    {
      question: "¿Qué enfoque terapéutico utilizas?",
      answer:
        "Trabajo principalmente desde la Terapia Cognitivo-Conductual (TCC), el enfoque con mayor respaldo empírico para una amplia variedad de problemas emocionales. Es un enfoque práctico, orientado a resultados.",
    },
    {
      question: "¿Cómo garantizas la calidad de tu trabajo?",
      answer:
        "Trabajo con rigor clínico, actualización constante, y supervisión profesional. La ética, la transparencia y el compromiso con el bienestar de mis pacientes son pilares fundamentales de mi práctica.",
    },
    {
  ...
  return (
    <SEOPageLayout
      ...
      description="Psicoterapia online privada para personas que viven en Suiza. Formación internacional y enfoque basado en la evidencia, sin esperas. 80 CHF la sesión."
    ...
    >
      <h2 className="text-2xl font-semibold mt-8 mb-4">Valores fundamentales de mi práctica</h2>

      <p>
        La honestidad y la transparencia son valores fundamentales en mi práctica. Esto significa que siempre serás
        informada sobre el proceso terapéutico, las técnicas que utilizamos, y el progreso que vamos logrando. No hay
        agendas ocultas ni promesas vacías: trabajamos con expectativas realistas y objetivos medibles para que puedas
        ver tu avance de manera tangible.
      </p>
      ...
      <h2 className="text-2xl font-semibold mt-10 mb-4">Sesiones estructuradas y orientadas a resultados</h2>

      <p>
        Las sesiones de TCC son estructuradas pero flexibles. Cada sesión tiene un propósito claro, revisamos tareas y
        aprendizajes de la semana, y establecemos objetivos para la siguiente. Esta estructura te ayuda a sentir que
        estás avanzando y te proporciona herramientas concretas que puedes aplicar en tu vida cotidiana desde las
        primeras sesiones.
      </p>

      <h2 className="text-2xl font-semibold mt-10 mb-4">Ventajas de la psicoterapia privada online</h2>

      <p>
        La psicoterapia privada online ofrece una serie de ventajas significativas frente a la terapia presencial
        tradicional, especialmente para personas que viven en Suiza. En un país donde la demanda de servicios de salud
        mental supera ampliamente la oferta, las listas de espera para terapeutas cubiertos por el seguro pueden ser de
        varios meses. La modalidad privada te permite comenzar tu proceso terapéutico cuando lo necesitas, sin esperas
        prolongadas que pueden agravar el malestar.
      </p>

      <ul>
        <li>
          <strong>Sin listas de espera:</strong> Podemos comenzar cuando estés lista, sin meses de espera que pueden
          empeorar tu situación
        </li>
        <li>
          <strong>Tarifas más accesibles:</strong> Las tarifas de terapia online son significativamente menores que las
          de la terapia presencial en Suiza, donde una sesión puede costar 200-250 CHF
        </li>
        <li>
          <strong>Flexibilidad total en los horarios:</strong> Ofrezco sesiones en horarios adaptados a agendas
          exigentes, incluyendo pausas del almuerzo y horarios fuera del trabajo
        </li>
        <li>
          <strong>Acceso desde cualquier lugar de Suiza:</strong> Ya sea que vivas en Zúrich, Ginebra, Basilea, Lausana,
          Berna o cualquier otra ciudad, puedes acceder a la terapia sin desplazamientos
        </li>
        <li>
          <strong>Atención en español con comprensión cultural:</strong> No solo hablamos el mismo idioma, sino que
          compartimos referencias culturales que enriquecen el proceso terapéutico
        </li>
        <li>
          <strong>Continuidad garantizada:</strong> Si viajas por trabajo o te mudas dentro de Suiza o Europa, el
          proceso terapéutico continúa sin interrupciones
        </li>
      </ul>
    </SEOPageLayout>
  );
