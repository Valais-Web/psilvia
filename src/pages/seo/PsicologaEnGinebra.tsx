...
const PsicologaEnGinebra = () => {
  const faqs = [
    {
      ...
      answer:
        "Sí, ofrezco psicoterapia online accesible desde cualquier punto de Ginebra y alrededores. La modalidad online te permite conectarte desde tu hogar u oficina sin desplazamientos.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Sí, Ginebra alberga una comunidad hispanohablante significativa en organizaciones internacionales, bancos y multinacionales. Sin embargo, encontrar atención psicológica en español localmente puede ser difícil y costoso. La comunidad hispanohablante en Ginebra es diversa y vibrante, con personas de México, España, Colombia, Argentina, Chile, Venezuela, Perú, y muchos otros países.",
    },
    {
      question: "¿Qué horarios manejas para Ginebra?",
      answer:
        "Trabajo en horario europeo con flexibilidad para adaptarme a agendas exigentes. Puedo ofrecer sesiones en pausas del almuerzo, primeras horas de la mañana o al final de la jornada laboral.",
    },
    {
      question: "¿Qué pasa si viajo frecuentemente por trabajo?",
      answer:
        "La terapia online permite mantener la continuidad del proceso sin importar dónde te encuentres. Muchos de mis pacientes viajan regularmente y mantenemos las sesiones sin interrupciones.",
    },
    {
  ...
  return (
    <SEOPageLayout
      ...
      description="Psicoterapia online para personas que viven en Ginebra. Atención psicológica privada en español sin esperas. 80 CHF la sesión."
    ...
    >
      <h2 className="text-2xl font-semibold mt-8 mb-4">Temas frecuentes entre hispanohablantes en Ginebra</h2>
      ...
      <p>
        Construir amistades profundas cuando sabes que la otra persona probablemente se irá en dos o tres años es
        emocionalmente agotador. Muchos me cuentan que después de varias despedidas dolorosas, se vuelven reacios a
        invertir emocionalmente en nuevas amistades.
      </p>

      <p className="mt-4">
        Los contratos temporales, las renovaciones inciertas, y la dependencia del empleador para mantener el estatus
        migratorio generan una inseguridad constante que puede manifestarse como ansiedad, insomnio, o irritabilidad.
      </p>

      <h2 className="text-2xl font-semibold mt-10 mb-4">Ventajas de la terapia online para quienes viven en Ginebra</h2>

      <ul>
        <li>
          <strong>Flexibilidad horaria:</strong> Sesiones adaptadas a agendas exigentes de organismos internacionales y
          multinacionales, incluyendo horarios fuera del típico 9-5
        </li>
        <li>
          <strong>Sin desplazamientos:</strong> Evitas perder tiempo en el tráfico o transporte público, tiempo que en
          Ginebra es especialmente valioso
        </li>
        <li>
          <strong>Continuidad en viajes:</strong> Mantienes tu proceso terapéutico aunque viajes por misión,
          conferencia, o vacaciones
        </li>
        <li>
          <strong>Atención en español:</strong> Sin depender de la limitada y costosa oferta local de psicólogos
          hispanohablantes
        </li>
        <li>
          <strong>Tarifas accesibles:</strong> Significativamente más económico que la terapia presencial en Ginebra,
          donde los precios son de los más altos de Suiza
        </li>
        <li>
          <strong>Privacidad total:</strong> Nadie en tu entorno laboral o social tiene que saber que estás en terapia
        </li>
      </ul>

      <h2 className="text-2xl font-semibold mt-10 mb-4">Comprendo tu contexto</h2>

      <p>
        Una de las ventajas de trabajar conmigo es que no tendrás que explicarme desde cero qué significa vivir en un
        entorno internacional, enfrentar la burocracia suiza, o navegar las diferencias culturales entre tu país de
        origen y la cultura suiza francófona. Conozco las particularidades de la vida expatriada, las dinámicas de las
        organizaciones internacionales, y los desafíos específicos que enfrentan las familias latinoamericanas y
        españolas en Europa.
      </p>

      <p className="mt-4">
        Este conocimiento contextual me permite ofrecerte un acompañamiento más preciso y relevante. No perdemos tiempo
        en explicaciones básicas sobre tu realidad; podemos ir directamente a lo que importa: comprender tu malestar y
        trabajar juntas para generar el cambio que necesitas. Si vives en Ginebra y buscas atención psicológica en
        español con alguien que entiende tu mundo, estoy aquí para ayudarte.
      </p>
    </SEOPageLayout>
  );
};
